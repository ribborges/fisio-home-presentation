...
import { Container, PanelFive, PanelFour, PanelOne, PanelSix, PanelThree, PanelTwo, ScreenImg, ScreenVideo } from "./style";
    ...
    <Container>
      ...
      <PanelFour>
        <div className="content">
          ...
          <div className="image">
            <img src="/static/img/phone.png" alt="User interface" />
          </div>
        </div>
      </PanelFour>
      <PanelFive>
      ...
      <PanelSix>
        <div className="content">
          <div className="content-div">
            <ScreenImg src="/static/img/login.jpg" alt="User interface" />
          </div>
          <div className="content-div">
            <ScreenImg src="/static/img/cadastro.jpg" alt="User interface" />
          </div>
          <div className="content-div">
            <ScreenImg src="/static/img/exercicios.jpg" alt="User interface" />
          </div>
          <div className="content-div">
            <ScreenImg src="/static/img/exercicio.jpg" alt="User interface" />
          </div>
          <div className="content-div">
            <ScreenVideo controls>
              <source src="/static/video/AppDemo.mp4" type="video/mp4" />
